...
private val AgentDockLightColors = lightColorScheme(
...
private val AgentDockDarkColors = darkColorScheme(
...
@Composable
fun AgentDockTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = if (isSystemInDarkTheme()) AgentDockDarkColors else AgentDockLightColors,
        content = content,
    )
}
