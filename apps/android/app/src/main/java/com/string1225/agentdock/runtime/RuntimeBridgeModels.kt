...
const val AGENT_DOCK_RUNTIME_BRIDGE_VERSION: Int = 1
...
class UnsupportedRuntimeBridgeVersionException(
    ...
    "Unsupported AgentDock runtime bridge version $actualVersion; expected $AGENT_DOCK_RUNTIME_BRIDGE_VERSION",
)
...
object RuntimeBridgeVersion {
    fun requireSupported(version: Int): Int {
        if (version != AGENT_DOCK_RUNTIME_BRIDGE_VERSION) {
