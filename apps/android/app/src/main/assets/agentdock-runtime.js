...
(() => {
  ...
  var installAgentDockRuntime = (target = resolveRuntimeGlobal()) => {
    var _a;
    ...
    const api = {
      start: (requestJson) => runtime.start(requestJson).catch((error) => {
        ...
        if (context !== void 0) {
          try {
            (_c = target.AgentDockNativeBridge) == null ? void 0 : _c.postMessage(
              JSON.stringify({
                version: ANDROID_BRIDGE_VERSION,
    ...
    try {
      (_a = target.AgentDockNativeBridge) == null ? void 0 : _a.postMessage(
        JSON.stringify({
          version: ANDROID_BRIDGE_VERSION,
          id: "runtime.ready",
          type: "event",
