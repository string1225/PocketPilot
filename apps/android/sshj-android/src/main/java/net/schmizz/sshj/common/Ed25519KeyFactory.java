...
// Modified by PocketPilot in 2026: use an unregistered bundled provider only for Ed25519.

import com.string1225.pocketpilot.sshj.PocketPilotEd25519;
...
public class Ed25519KeyFactory {
    ...
    private static final byte[] ED25519_PKCS8_PUBLIC_KEY_HEADER =
            Base64.getDecoder().decode("MCowBQYDK2VwAyEA");
    ...
    public static PrivateKey getPrivateKey(final byte[] privateKeyBinary)
        ...
        System.arraycopy(
                ...
                privateKeyEncoded,
                0,
                ED25519_PKCS8_PRIVATE_KEY_HEADER.length
        );
        System.arraycopy(
                privateKeyBinary,
                0,
        ...
        final KeyFactory keyFactory = PocketPilotEd25519.newKeyFactory();
        return keyFactory.generatePrivate(keySpec);
    }

    public static PublicKey getPublicKey(final byte[] publicKeyBinary)
            throws GeneralSecurityException {
        ...
        System.arraycopy(
                ...
                publicKeyEncoded,
                0,
                ED25519_PKCS8_PUBLIC_KEY_HEADER.length
        );
        System.arraycopy(
                publicKeyBinary,
                0,
